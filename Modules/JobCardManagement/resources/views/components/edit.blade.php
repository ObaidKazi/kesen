    ...
    <div class="content" style="padding-top: 20px;margin-left: 10px">
        ...
        <form action="{{ route('jobcardmanagement.update', $jobCard->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row pt-2">
                ...
                <x-adminlte-select name="handled_by" fgroup-class="col-md-6" required value="{{ old('handled_by') }}" label="Handle By">
                ...
                <x-adminlte-textarea name="description" placeholder="Description" fgroup-class="col-md-6" label="Description">{{$jobCard->description}}</x-adminlte-textarea>
                <x-adminlte-select name="site_specific" fgroup-class="col-md-6" id="site_specific" required value="{{ old('site_specific', $jobCard->site_specific) }}" label="Site Specific">
                ...
                <x-adminlte-input name="bill_no" placeholder="Bill Number" fgroup-class="col-md-6" value="{{ old('bill_no', $jobCard->bill_no) }}" label="Bill Number" />
                <x-adminlte-input name="protocol_no" placeholder="Protocol Number" fgroup-class="col-md-6" value="{{ old('protocol_no', $jobCard->protocol_no) }}" label="Protocol Number" />
                ...
                <x-adminlte-input name="pd" placeholder="PD" fgroup-class="col-md-6" value="{{ old('pd', $jobCard->pd) }}" label="PD" />
                <x-adminlte-input name="cr" placeholder="CR" fgroup-class="col-md-6" value="{{ old('cr', $jobCard->cr) }}" label="CR" />
                <x-adminlte-input name="cn" placeholder="CN" fgroup-class="col-md-6" value="{{ old('cn', $jobCard->cn) }}" label="CN" />
                <x-adminlte-input name="dv" placeholder="DV" fgroup-class="col-md-6" value="{{ old('dv', $jobCard->dv) }}" label="DV" />
