        ...
        <form action="{{ route('employeemanagement.store') }}" method="POST" >
            ...
            <div class="row pt-2">
                ...
                <x-adminlte-input name="phone_no"  placeholder="Employee Number"
                    ...
                    fgroup-class="col-md-6" type='email' value="{{ old('email') }}" required/>

                    <x-adminlte-input name="code"  placeholder="Employee Code"
                    fgroup-class="col-md-6" type='text' value="{{ old('code') }}" required/>
                    
                    <x-adminlte-input name="password"  placeholder="Password"
                    fgroup-class="col-md-6" type='password' value="{{ old('password') }}" required/> 
                    <x-adminlte-input name="confirm_password"  placeholder="Confirm Password" 
                    fgroup-class="col-md-6" type='password' value="{{ old('confirm_password') }}" required/> 
