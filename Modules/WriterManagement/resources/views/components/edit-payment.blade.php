        ...
        <x-adminlte-card title="Edit Payment" theme="success">
            <form action="{{ route('writermanagement.editPayment', [$id, $payment->id]) }}" method="POST">
                ...
                <div class="row pt-2">
                    ...
                    <x-adminlte-input name="deductible" placeholder="Deductible" fgroup-class="col-md-6" type="number" step="0.01" required value="{{ old('deductible', $payment->deductible) }}" label="Deductible"/>
                </div>
