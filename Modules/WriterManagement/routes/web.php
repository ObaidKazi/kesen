...
Route::put('writer-management/{writer_id}/edit-language-maps/{id}', [WriterManagementController::class, 'updateLanguageMap'])->name('writermanagement.updateLanguageMap');
